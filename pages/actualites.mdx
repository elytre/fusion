...
Olivier Bordaçarre sera présent sur le festival. Il animera une lecture spectacle le 13 mai. Il sera également présent sur la table ronde "Vies ordinaires en huit-clos", le 15 mai.<br/>
        </p>
        <p>
          <a
