<div className="news-page">
  ...
  <article className="news">
      ...
      <div className="news-body">
        <p>
          <i> Clark </i> d'Anouk Langaney est sélectionné pour le grand prix du jury du festival Pôle Art 2021 ! <br/>
          Toute la sélection : <br/>
          La mère noire, Jean-Bernard Pouy & Marc Villard <br/>
          La patience de l'immortelle, Michèle Pedinielli <br/>
          Lëd, Caryl Férey <br/>
          Stavros contre Goliath, Sophia Mavroudis <br/>
          Moktar, Jérémy Bouquin <br/>
          Clark, Anouk Langaney <br/>
        </p>
        <p>
          <a
  ...
  <article className="news">
    ...
    <article className="news">
      <div className="news-illustration">
        <img
          src={require('./parution-nuit-bleue.news.jpg').default}
