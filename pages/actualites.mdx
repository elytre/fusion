...
<article className="news">
 ...
 <article className="news">
      <div className="news-illustration">
        <img
          src={require('./Les Affluents-Bordaçarre.jpg').default}
          alt="Festival Polar, Vin et Compagnie"
          className="news-illustration-image"
        />
      </div>
      <h1 className="news-title">
        Festival Les Affluents – Ancenis-Saint-Géréon – Du 24 au 24 Juin 2022
      </h1>
      <p className="news-date">
      ...
      <div className="news-body">
        ...
        Pierre Bordage et Olivier Bordaçarre seront présents sur cette première édition.
        </p>
        <p>
          <a
