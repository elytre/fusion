...
<article className="news">
      <div className="news-illustration">
        <img
          src={require('./tachenoire_vignette_2023.jpg').default}
          alt="Rencontre avec Simone Buchholz à la Librairie-Café La Tache noire"
...
<article className="news">
      <div className="news-illustration">
        <img
          src={require('./geotheque_vignette_2023.jpg').default}
          alt="Rencontre avec Simone Buchholz à la Librairie La Géothèque"
          className="news-illustration-image"
        />
      </div>
      <h1 className="news-title">
