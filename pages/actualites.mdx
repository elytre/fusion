<div className="news-page">
  ...
  <article className="news">
      ...
      <div className="news-body">
        <p>
          Anouk Langaney est aussi invitée au salon Noir sur la ville de Lamballe qui aura lieu les 20 et 21 novembre prochains.<br/>
        </p>
        <p>
          <a
  ...
  <article className="news">
      <div className="news-illustration">
        <img
          src={require('./toulouse_vignette.jpg').default}
