...
<article className="news">
 ...
 <article className="news">
      <div className="news-illustration">
        <img
          src={require('./polaretvin.jpg').default}
          alt="Festival Polar, Vin et Compagnie"
          className="news-illustration-image"
        />
      </div>
      <h1 className="news-title">
        Festival Polar, Vin et Compagnie – Millau – Du 13 au 15 Mai 2022
      </h1>
      <p className="news-date">
        <time dateTime="2022-04-09"> 9 Avril 2022</time>
      </p>
      <div className="news-body">
        <p>
        Le Festival Polar et Vin aura lieu à Millau du 12 au 15 mai 2022.
        Olivier Bordaçarre sera présent sur le festival. Il animera une lecture spectacle le 13 mai. Il sera également présent sur la table ronde "Vies ordinaires en huit-clos", le 15 mai.
        </p>
        <p>
          <a
            href="https://www.tourisme-aveyron.com/fr/diffusio/agenda/festival-polar-et-vin-millau_TFO440009308950"
            rel="noopener noreferrer"
            target="_blank"
          >
          Plus d'informations sur le site du festival
