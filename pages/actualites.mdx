...
<article className="news">
      <div className="news-illustration">
        <img
          ...
          alt="[FORMAT COURT] Polar & imaginaire - Les livres des Pays de la Loire #03 - Mai 2022"
          className="news-illustration-image"
        />
      </div>
      <h1 className="news-title">
        Caroline de Benedetti et Emeric Cloche, directeurs de la collection Fusion, présentent 5 livres édités par des maisons des Pays de la Loire et/ou écrits par des auteurs et autrices du territoire.
      </h1>
      ...
      <div className="news-body">
        <div className="news-youtube-video">
          <iframe width="560" height="315" 
            src="https://www.youtube.com/watch?v=q8KpqHF9q-8&t=373s" 
            frameBorder="0" 
