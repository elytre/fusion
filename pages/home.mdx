<div className="home-page">
  ...
  <div className="headline">
    <a href="/fr/p/un-conte-parisien-violent">
      <img
        src={require('./bandeau-Conte-Parisien-facebook.jpg').default}
  ...
  <div className="home-products">
    <div className="home-products-section">
      <article className="home-product">
        ...
        <a href="/fr/p/la-recolte-des-enfants">
          <img src="/la-recolte-des-enfants.cover.jpg" alt="Couverture du livre La Récolte des enfants" className="home-product-cover" />
        </a>
        <h1 className="home-product-title">
          <a href="/fr/p/la-recolte-des-enfants">La Récolte des enfants</a>
        </h1>
