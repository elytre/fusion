<div className="home-page">
  ...
  <div className="headline">
    <a href="/fr/p/rue-mexico">
      <img
        src={require('./accueil_rue_mexico_last_chance.jpg').default}
    ...
    <div className="home-products-section">
      <article className="home-product">
        ...
        <a href="/fr/p/un-conte-parisien-violent">
          <img src="/un-conte-parisien-violent.cover.jpg" alt="Couverture du livre Un conte parisien violent" className="home-product-cover" />
        </a>
        <h1 className="home-product-title">
          <a href="/fr/p/un-conte-parisien-violent">Un conte parisien violent</a>
        </h1>
