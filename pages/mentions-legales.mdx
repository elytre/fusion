<div className="legal-page">
  ...
  <div className="legal-page-block">
...
Le site ??? a pour objet de fournir une information concernant l’ensemble des
activités de la société.

Le propriétaire du site s’efforce de fournir sur le site ??? des informations
...
Toutes les informations proposées sur le site ??? sont données à titre
...
Le site www.???.com contient un certain nombre de liens hypertextes vers
...
Sur le site www.???.com, le propriétaire du site ne collecte des informations
personnelles relatives à l'utilisateur que pour le besoin de certains services
proposés (newsletter) par le site www.???.com. L'utilisateur fournit ces
informations en toute connaissance de cause, notamment lorsqu'il procède par
lui-même à leur saisie. Il est alors précisé à l'utilisateur du site www.???.com
...
votre demande à www.???.com par email : bonjour@l-atalante.fr ou en effectuant
...
Aucune information personnelle de l'utilisateur du site www.???.com n'est
publiée à l'insu de l'utilisateur, échangée, transférée, cédée ou vendue sur un
support quelconque à des tiers. Seule l'hypothèse du rachat du site www.???.com
...
l'utilisateur du site www.???.com.

Le site www.l-atalante.com est en conformité avec le RGPD.
